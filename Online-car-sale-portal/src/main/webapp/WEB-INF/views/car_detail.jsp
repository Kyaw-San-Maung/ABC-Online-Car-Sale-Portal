<%@page import="com.example.Onlinecarsaleportal.entities.Car"%>
...
<div class="row">
		...
		<div class="col-md-8 containerForCarDetailTable">
		<h4 class="fs-5 fw-bold">Detail information from owner.</h4><br/>
		<form:form >
	    ...
	    <tr>
	      <th><label for="make" >Car Photo:</label></th>
	      <td><div class="col-sm-8"><img src="/images/${car.carphoto}" style="width: 60px; height: 45px"></div></td>
	    </tr>
		 ...
		 <tr>
				...
				<div class="col-sm-8" style="padding: 20px;">
					...
					<form action="car_detail?id=${car.id}" method="post">
						...
						<input
							...
							value="${_csrf.token}" /> 
							<input type="number"
							placeholder="Enter Bid Price" name="bitprice" class="inputBox bidInputBox"/>

						<div class="form-group" style="padding: 20px;">
							<input type="submit" value="Bit Car" class="btn success btn1 bidBtn">
							<a href="cars" class="btn btn1" style="">Go Back</a>
						</div>
			...
			<c:forEach var="car_bidding" items="${bidinfo}">
				<div class="card mb-3 card bg-info" style="padding:20px; border-radius: 10px">
